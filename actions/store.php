...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Validation simple : l'heure de début doit être avant l'heure de fin
    ...
    /*
        ...
        à la même date et dans un créneau qui se croise.
    */
    $sqlConflit = "
    ...
    // Si une réservation existe déjà, on bloque l'ajout
    if ($reservationExiste && $statut != "annulee") {
